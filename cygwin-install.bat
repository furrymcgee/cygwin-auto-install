...
SET PACKAGES=%PACKAGES%,lua,perl,perl_manpages,asciidoc
SET PACKAGES=%PACKAGES%,bzip2,openssl,p7zip,unzip,xz-utils,zip
SET PACKAGES=%PACKAGES%,inetutils,socat,ncurses,syslog-ng,curl
SET PACKAGES=%PACKAGES%,busybox,pandoc,recutils,expat,libexpat-devel
SET PACKAGES=%PACKAGES%,cygport,cygwin-devel,meson,robodoc,help2man
