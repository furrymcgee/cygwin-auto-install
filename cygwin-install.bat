...
SET PACKAGES=%PACKAGES%,bash-completion,doxygen,ImageMagick,doxygwin
...
SET PACKAGES=%PACKAGES%,libsearch-xapian-perl,xapian-tools,python-docutils
...
SET PACKAGES=%PACKAGES%,dpkg,debhelper,strip-nondeterminism,debconf,dh-exec,dh-make,dh-python
