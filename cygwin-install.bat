...
SET PACKAGES=%PACKAGES%,cygwin-devel,libncurses-devel,libdb-devel
SET PACKAGES=%PACKAGES%,db,perl-CGI,postgresql,ImageMagick
SET PACKAGES=%PACKAGES%,robodoc,help2man,asciidoc,transfig,netpbm
SET PACKAGES=%PACKAGES%,python-docutils,bash-completion,doxygen
